...
public class SignInstance {
    ...
    private int radius;//签到半径

    public SignInstance() { }

    public SignInstance(Integer signInstID, Integer signID, Date startTime, Date endTime, String longitude, String latitude, String placeName, Date date, int radius) {
